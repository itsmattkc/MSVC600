...
EXTERN_C const IID IID_IJavaEnumRemoteThreadGroup;
    ...
    interface DECLSPEC_UUID("CB33C08E-16E6-11d0-ACBB-00401C608501")
    IJavaEnumRemoteThreadGroup : public IEnumRemoteThreadGroup
    {
    public:
        virtual HRESULT STDMETHODCALLTYPE GetNext( 
...
EXTERN_C const IID IID_IRemoteThread;
    ...
    interface DECLSPEC_UUID("275d9d91-5ff5-11cf-a5e1-00aa006bbf16")
    IRemoteThread : public IUnknown
    {
    public:
        virtual HRESULT STDMETHODCALLTYPE GetName( 
            /* [out] */ LPOLESTR __RPC_FAR *ppszName) = 0;
...
EXTERN_C const IID IID_IEnumRemoteThread;
    ...
    interface DECLSPEC_UUID("275d9da3-5ff5-11cf-a5e1-00aa006bbf16")
    IEnumRemoteThread : public IUnknown
    {
    public:
        virtual HRESULT STDMETHODCALLTYPE Next( 
            /* [in] */ ULONG celt,
...
EXTERN_C const IID IID_IJavaEnumRemoteThread;
    ...
    interface DECLSPEC_UUID("CB33C08F-16E6-11d0-ACBB-00401C608501")
    IJavaEnumRemoteThread : public IEnumRemoteThread
    {
    public:
        virtual HRESULT STDMETHODCALLTYPE GetNext( 
...
EXTERN_C const IID IID_IRemoteProcessCallback;
    ...
    interface DECLSPEC_UUID("275d9d94-5ff5-11cf-a5e1-00aa006bbf16")
    IRemoteProcessCallback : public IUnknown
    {
    public:
...
EXTERN_C const IID IID_IRemoteProcess;
    ...
    interface DECLSPEC_UUID("275d9d93-5ff5-11cf-a5e1-00aa006bbf16")
...
EXTERN_C const IID IID_IEnumRemoteProcess;
    ...
    interface DECLSPEC_UUID("275d9da5-5ff5-11cf-a5e1-00aa006bbf16")
    IEnumRemoteProcess : public IUnknown
    {
    public:
        virtual HRESULT STDMETHODCALLTYPE Next( 
            /* [in] */ ULONG celt,
...
EXTERN_C const IID IID_IJavaEnumRemoteProcess;
    ...
    interface DECLSPEC_UUID("CB33C090-16E6-11d0-ACBB-00401C608501")
    IJavaEnumRemoteProcess : public IEnumRemoteProcess
    {
    public:
        virtual HRESULT STDMETHODCALLTYPE GetNext( 
...
EXTERN_C const IID IID_IRemoteDebugManagerCallback;
    ...
    interface DECLSPEC_UUID("275d9d61-5ff5-11cf-a5e1-00aa006bbf16")
    IRemoteDebugManagerCallback : public IUnknown
    {
    public:
...
EXTERN_C const IID IID_IRemoteDebugManager;
    ...
    interface DECLSPEC_UUID("275d9d60-5ff5-11cf-a5e1-00aa006bbf16")
    IRemoteDebugManager : public IUnknown
    {
    public:
        virtual HRESULT STDMETHODCALLTYPE RegisterCallback( 
...
EXTERN_C const IID IID_IJavaDebugManager;
    ...
    interface DECLSPEC_UUID("275d9dc0-5ff5-11cf-a5e1-00aa006bbf16")
    IJavaDebugManager : public IUnknown
    {
    public:
...
#ifndef __IProcessDestroyHack_INTERFACE_DEFINED__
#define __IProcessDestroyHack_INTERFACE_DEFINED__

/****************************************
 * Generated header for interface: IProcessDestroyHack
 * at Sat Aug 16 03:41:06 1997
 * using MIDL 3.01.75
 ****************************************/
/* [uuid][object] */ 
...
EXTERN_C const IID IID_IProcessDestroyHack;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    interface DECLSPEC_UUID("F248BC3A-15D1-11d1-A36A-00C04FB68D0E")
    IProcessDestroyHack : public IUnknown
    {
    public:
        virtual HRESULT STDMETHODCALLTYPE RegisterProcessDestroyHack( 
            /* [unique][in] */ IRemoteProcessCallback __RPC_FAR *pirpcb,
            /* [in] */ DWORD hevtEnd,
            /* [out] */ DWORD __RPC_FAR *pdwDebugMgrProcessID,
            /* [out] */ DWORD __RPC_FAR *phevtStart) = 0;
        
        virtual HRESULT STDMETHODCALLTYPE DetachProcessDestroyHack( void) = 0;
        
    };
    
#else 	/* C style interface */

    typedef struct IProcessDestroyHackVtbl
    {
        BEGIN_INTERFACE
        
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *QueryInterface )( 
            IProcessDestroyHack __RPC_FAR * This,
            /* [in] */ REFIID riid,
            /* [iid_is][out] */ void __RPC_FAR *__RPC_FAR *ppvObject);
        ...
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *RegisterProcessDestroyHack )( 
            IProcessDestroyHack __RPC_FAR * This,
            /* [unique][in] */ IRemoteProcessCallback __RPC_FAR *pirpcb,
            /* [in] */ DWORD hevtEnd,
            /* [out] */ DWORD __RPC_FAR *pdwDebugMgrProcessID,
            /* [out] */ DWORD __RPC_FAR *phevtStart);
        
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *DetachProcessDestroyHack )( 
            IProcessDestroyHack __RPC_FAR * This);
        
        END_INTERFACE
    } IProcessDestroyHackVtbl;

    interface IProcessDestroyHack
    {
        CONST_VTBL struct IProcessDestroyHackVtbl __RPC_FAR *lpVtbl;
    };
...
#define IProcessDestroyHack_QueryInterface(This,riid,ppvObject)	\
    (This)->lpVtbl -> QueryInterface(This,riid,ppvObject)

#define IProcessDestroyHack_AddRef(This)	\
    (This)->lpVtbl -> AddRef(This)

#define IProcessDestroyHack_Release(This)	\
    (This)->lpVtbl -> Release(This)


#define IProcessDestroyHack_RegisterProcessDestroyHack(This,pirpcb,hevtEnd,pdwDebugMgrProcessID,phevtStart)	\
    (This)->lpVtbl -> RegisterProcessDestroyHack(This,pirpcb,hevtEnd,pdwDebugMgrProcessID,phevtStart)

#define IProcessDestroyHack_DetachProcessDestroyHack(This)	\
    (This)->lpVtbl -> DetachProcessDestroyHack(This)
...
HRESULT STDMETHODCALLTYPE IProcessDestroyHack_RegisterProcessDestroyHack_Proxy( 
    IProcessDestroyHack __RPC_FAR * This,
    /* [unique][in] */ IRemoteProcessCallback __RPC_FAR *pirpcb,
    /* [in] */ DWORD hevtEnd,
    /* [out] */ DWORD __RPC_FAR *pdwDebugMgrProcessID,
...
void __RPC_STUB IProcessDestroyHack_RegisterProcessDestroyHack_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IProcessDestroyHack_DetachProcessDestroyHack_Proxy( 
    IProcessDestroyHack __RPC_FAR * This);


void __RPC_STUB IProcessDestroyHack_DetachProcessDestroyHack_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
#endif 	/* __IProcessDestroyHack_INTERFACE_DEFINED__ */
