...
typedef struct _SHARE_INFO_1007 {
    DWORD  shi1007_flags;
    LPTSTR shi1007_AlternateDirectoryName;
} SHARE_INFO_1007, *PSHARE_INFO_1007, *LPSHARE_INFO_1007;
...
//
// The subset of 1005 and 1007 infolevel flags that can be set via the API
//
