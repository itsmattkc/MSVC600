...
WINOLEAPI CoGetClassInfo(
    uCLSSPEC *          pClassSpec,
    QUERYCONTEXT *      pContext );
...
WINOLEAPI CoGetPublishedAppInfo(
    APPINFOTYPE         QueryType,
    DWORD *             pCount,
    PUBLISHEDAPPINFO ** ppInfo );
...
//
WINOLEAPI CreateStdProgressIndicator(HWND hwndParent,
                                   LPCOLESTR pszTitle,
