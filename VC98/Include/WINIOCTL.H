...
#define REPLACE_ALTERANTE  0xB // Replace - the alternate volume tag - current tag ignored.
...
#define USN_REASON_MOUNT_TABLE_CHANGE    (0x00200000)
...
#define INFO_NO_ENCRYPTED_STREAMS   0x1
